...
from .execution.volatility_hedge import VolatilityHedgeConfig, VolatilityHedgeManager, position_from_summary
        ...
        for position in self.manager.positions.values():
            ...
            conn.execute(
                ...
                INSERT OR REPLACE INTO volatility_hedge_positions (
                    ...
                    imbalance_ratio, total_cost, last_features_json, fills_json, updated_at
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                (
                    ...
                    row["imbalance_ratio"], row["total_cost"], json.dumps(row["last_features_json"], sort_keys=True),
        ...
        for event in self.manager.events:
            conn.execute(
                ...
                INSERT INTO volatility_hedge_events (
                    ...
                    up_bid, up_ask, down_bid, down_ask, raw_json
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                (
